...
#ifdef ZMATHLIB_EXPORTS  
#define ZMATHLIB_API __declspec(dllexport)   
#else  
#define ZMATHLIB_API __declspec(dllimport)   
#endif
...
namespace DirectX
{
	namespace SimpleMath
	{
		...
		//------------------------------------------------------------------------------
		// 2D vector
		struct ZMATHLIB_API Vector2 : public XMFLOAT2
		{
		...
		//------------------------------------------------------------------------------
		// 3D vector
		struct ZMATHLIB_API Vector3 : public XMFLOAT3
		{
			...
			static Vector3 Cross(const Vector3& V0, const Vector3& V1) noexcept;
		...
		//------------------------------------------------------------------------------
		// 4D vector
		struct ZMATHLIB_API Vector4 : public XMFLOAT4
		{
			...
			XM_CONSTEXPR Vector4(const Vector3& ixyz, float iw) noexcept : XMFLOAT4(ixyz.x, ixyz.y, ixyz.z, iw) {}
			...
			float Dot3(const Vector4& V) const noexcept;
		...
		struct ZMATHLIB_API Matrix : public XMFLOAT4X4
		{
			Matrix() noexcept
		...
		// Unary operators
			...
			static Matrix CreateInfinityProj(float fovRad, float aspect) noexcept;
		...
		//-----------------------------------------------------------------------------
		// Plane
		struct ZMATHLIB_API Plane : public XMFLOAT4
		{
		...
		//------------------------------------------------------------------------------
		// Quaternion
		struct ZMATHLIB_API Quaternion : public XMFLOAT4
		{
		...
		//------------------------------------------------------------------------------
		// Color
		struct ZMATHLIB_API Color : public XMFLOAT4
		{
...
{
	ZMATHLIB_API std::vector<DirectX::SimpleMath::Vector4> GetFrustumCornersWorldSpace(const DirectX::SimpleMath::Matrix& view, const DirectX::SimpleMath::Matrix& proj);
}
