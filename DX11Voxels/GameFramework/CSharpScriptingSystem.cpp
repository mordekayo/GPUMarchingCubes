...
ZGame::CSharpScriptingSystem::CSharpScriptingSystem()
{
	Init();
}


void ZGame::CSharpScriptingSystem::Init()
{
	...
	const char* params[2] = { "--debugger-agent=transport=dt_socket,server=y,address=127.0.0.1:55555", "--use-fallback-tls"};
	...
	CoreAssembly = LoadMonoAssembly("Scripts/SharpScriptCore.dll");
...
void ZGame::CSharpScriptingSystem::Reload()
{
...
void ZGame::CSharpScriptingSystem::PrintAssemblyTypes(MonoAssembly* assembly)
{
