...
namespace sol_ImGui
{
	...
	inline float GetWindowDpiScale() { return 1.0f; /* TODO: GetWindowDpiScale() ==> UNSUPPORTED */ }
	...
	// TODO Check this obsolete warning
	inline void OpenPopupContextItem() { ImGui::OpenPopupContextItem(); }
	inline void OpenPopupContextItem(const std::string& str_id) { ImGui::OpenPopupContextItem(str_id.c_str()); }
	inline void OpenPopupContextItem(const std::string& str_id, int popup_flags) { ImGui::OpenPopupContextItem(str_id.c_str(), static_cast<ImGuiPopupFlags>(popup_flags)); }
