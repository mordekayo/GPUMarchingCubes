...
[numthreads(8, 8, 8)]
void FillVolume(in uint3 coords : SV_DispatchThreadID)
{
	...
	float3 finalCoords = Params.PositionIsoline.xyz + texCoords + Params.Offset.xyz;
	finalCoords *= Params.SizeXYZScale.w;
	volumeTex[volCoords.xyz] = noise(finalCoords.x, finalCoords.y, finalCoords.z);
}
